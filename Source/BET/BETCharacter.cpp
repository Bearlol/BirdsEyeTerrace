...
void ABETCharacter::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	...
	InputComponent->BindAction("UseActiveAbility", IE_Pressed, CallOut, &UBETShoutOut::ActivateAbility);
	InputComponent->BindAction("UseActiveAbility", IE_Pressed, CallOut, &UBETShoutOut::DeactivateAbility);
}
